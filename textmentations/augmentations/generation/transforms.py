...
from textmentations.augmentations.utils import _from_pretrained_albert_mlm, _from_pretrained_bert_tokenizer_fast
...
_albert_model = _from_pretrained_albert_mlm(model_path=_ALBERT_MODEL_PATH).eval()
_albert_tokenizer = _from_pretrained_bert_tokenizer_fast(model_path=_ALBERT_MODEL_PATH)
