...
def _crop_text(text: Text, start_index: int, end_index: int) -> Text:
    """Cuts the text from the start index to the end index."""
    return _cut_string_by_index(text, start_index, end_index)


def cut_words(text: Text, length: int, begin: bool) -> Text:
    """Cuts a port of each word in the text from the beginning or end."""
    return _cut_words(text, length, begin)


@autopsy_text
def _cut_words(sentences: List[Sentence], length: int, begin: bool) -> List[Sentence]:
    """Cuts a port of each word in the list of sentences from the beginning or end."""
...
def _cut_words_in_sentence(words: List[Word], length: int, begin: bool) -> List[Word]:
    """Cuts a port of each word in the list of words from the beginning or end."""
...
def _cut_string_by_length(string: Corpus, length: int, begin: bool) -> Corpus:
    """Cuts a port of the string by the length from the beginning or end."""
...
def cut_sentences(text: Text, length: int, begin: bool) -> Text:
    """Cuts a port of each sentence in the text from the beginning or end."""
    return _cut_sentences(text, length, begin)


@autopsy_text
def _cut_sentences(sentences: List[Sentence], length: int, begin: bool) -> List[Sentence]:
    """Cuts a port of each sentence in the list of sentences from the beginning or end."""
...
def cut_text(text: Text, length: int, begin: bool) -> Text:
    """Cuts a port of the text from the beginning or end."""
...
def insert_synonyms(text: Text, insertion_prob: float, n_times: int) -> Text:
    """Randomly inserts synonyms of words that are not stopwords into the text n times.
...
def _insert_synonyms(sentences: List[Sentence], insertion_prob: float, n_times: int) -> List[Sentence]:
    """Randomly inserts synonyms of words that are not stopwords in each sentence n times."""
...
def _insert_synonyms_in_sentence(words: List[Word], insertion_prob: float, n_times: int) -> List[Word]:
    """Randomly inserts synonyms of words that are not stopwords into the list of words n times."""
...
def swap_words(text: Text, n_times: int) -> Text:
    """Randomly swaps two words in a randomly selected sentence from the text n times.
...
def _swap_words(sentences: List[Sentence], n_times: int) -> List[Sentence]:
    """Randomly swaps two words in a randomly selected sentence n times."""
...
def swap_sentences(text: Text, n_times: int) -> Text:
    """Randomly swaps two sentences in the text n times.
...
def _swap_sentences(sentences: List[Sentence], n_times: int) -> List[Sentence]:
    """Randomly swaps two sentences in the list of sentences n times."""
    augmented_sentences = sentences
    for _ in range(n_times):
